const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/LoginPage-CwmL2HEN.js","assets/useAuth-Wrzmam0S.js","assets/DashboardPage-BPZgusgz.js"])))=>i.map(i=>d[i]);
...
const LoginPage = reactExports.lazy(() => __vitePreload(() => import("./LoginPage-CwmL2HEN.js"), true ? __vite__mapDeps([0,1]) : void 0));
const DashboardPage = reactExports.lazy(() => __vitePreload(() => import("./DashboardPage-BPZgusgz.js"), true ? __vite__mapDeps([2,1]) : void 0));
...
const rootRoute = createRootRoute({
  component: () => /* @__PURE__ */ jsxRuntimeExports.jsx(QueryClientProvider, { client: queryClient$1, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(InternetIdentityProvider, { children: [
...
function PageLoader() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-background flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-6 h-6 border-2 border-primary border-t-transparent rounded-full animate-spin" }) });
}
function App() {
...
export {
  bitGet as $,
  _createCurveFields as A,
  wNAF as B,
  CborEncodeErrorCode as C,
  ensureBytes as D,
  ExpiryJsonDeserializeErrorCode as E,
  FpInvertBatch as F,
  _abool2 as G,
  _abytes2 as H,
  InputError as I,
  ...
  safeReadUint8 as a,
  sha256 as a0,
  numberToBytesBE as a1,
  UNREACHABLE_ERROR as a2,
  UnknownError as a3,
  HashTreeDecodeErrorCode as a4,
  uint8Equals as a5,
  ProtocolError as a6,
  CertificateVerificationErrorCode as a7,
  TrustError as a8,
  CertificateTimeErrorCode as a9,
  TimeoutWaitingForResponseErrorCode as aA,
  uint8FromBufLike as aB,
  HttpErrorCode as aC,
  TransportError as aD,
  HttpFetchErrorCode as aE,
  MalformedSignatureErrorCode as aF,
  CertificateOutdatedErrorCode as aG,
  MissingSignatureErrorCode as aH,
  IC_RESPONSE_DOMAIN_SEPARATOR as aI,
  HttpDefaultFetchErrorCode as aJ,
  RequestStatusDoneNoReplyErrorCode as aK,
  RejectError as aL,
  CertifiedRejectErrorCode as aM,
  InvalidReadStateRequestErrorCode as aN,
  MissingCanisterIdErrorCode as aO,
  UncertifiedRejectErrorCode as aP,
  UncertifiedRejectUpdateErrorCode as aQ,
  useRouter as aR,
  Link as aS,
  useInternetIdentity as aT,
  ue as aU,
  React$4 as aV,
  UnexpectedErrorCode as aa,
  CertificateHasTooManyDelegationsErrorCode as ab,
  CertificateNotAuthorizedErrorCode as ac,
  MissingLookupValueErrorCode as ad,
  DerKeyLengthMismatchErrorCode as ae,
  DerPrefixMismatchErrorCode as af,
  LookupErrorCode as ag,
  MalformedLookupFoundValueErrorCode as ah,
  hexToBytes as ai,
  ExternalError as aj,
  MissingRootKeyErrorCode as ak,
  AgentError as al,
  wrapDER as am,
  unwrapDER as an,
  DerDecodeErrorCode as ao,
  ED25519_OID as ap,
  hashOfMap as aq,
  MalformedPublicKeyErrorCode as ar,
  ed25519 as as,
  QuerySignatureVerificationFailedErrorCode as at,
  AnonymousIdentity as au,
  IngressExpiryInvalidErrorCode as av,
  CreateHttpAgentErrorCode as aw,
  IdentityInvalidErrorCode as ax,
  requestIdOf as ay,
  HttpV3ApiNotSupportedErrorCode as az,
  readIntLE as b,
  writeUIntLE as c,
  readUIntLE as d,
  safeRead as e,
